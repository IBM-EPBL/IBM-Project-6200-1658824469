  ...
  <div id="menu">
   ...
   <div class="container">
	 <div class="row">
		...
		<form action="database/login1.php" method="POST" >
    ...
    <div class="alert alert-danger" role="alert">
      ...
      <?php }?>
			<div class="form-group">
				...
				<label>UserName:</label><input type="text" name="username" class="form-control" autofocus placeholder="Enter your username" required="">
			</div>
			<div class="form-group">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <input type="text" name="captcha" class="form-control" readonly id="capt" required="">
        </div>
        <div class="form-group col-md-6">
	...
	<div class="form-group">
<button onclick="validcap()" name="save" class="btn btn-lg btn-success btn-block" >Login</button>
			</div>
		</form>
