...
<div class="full-page">
  <div id="menu">
        <ul>
          ...
          <li><a href='feedbaack page.html'>FEEDBACK</a></li>
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <?php }?>
			<div class="form-group">
				<label>Bank user ID:</label><input type="text" name="BankUserName" class="form-control" autofocus placeholder="Enter the Bank User ID">
			</div>
			<div class="form-group">
				<label>Bank Email ID:</label><input type="email" name="bankemail" class="form-control" autofocus placeholder="Enter the Bank Email ID">
			</div>
            <div class="form-group">
